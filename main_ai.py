...
try:
    ...
    pass
try:
    with open("allergies_and_restrictions.json","r") as ar:
        allergies_and_restrictions.clear()
        allergies_and_restrictions.update(set(json.load(ar)))
except FileNotFoundError:
    with open("allergies_and_restrictions.json","w") as temp:
        pass
except json.JSONDecodeError:
    pass
                    ...
                    if m == -2:
                        ...
                        if r == -2:
                            ...
                            if i == -2:
                                ...
                                if saved_menus[d][m][i-1].name in favorites_set:
        ...
        case 6: #allergies
            ...
            match choice:
                ...
                case -1:
                    print("Input out of range")
                case 1:
                    new_item=input("Enter allergy/dietary restriction: ")
                    if not isinstance(new_item,int):
                        ...
                        print("Number cannot be added to allergy/dietary restrictions")
                case 2:
...
with open("allergies_and_restrictions.json","w") as ar:
